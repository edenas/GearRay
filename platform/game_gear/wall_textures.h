...
#define GAME_GEAR_WALL_TEXTURE_WIDTH 8
#define GAME_GEAR_WALL_TEXTURE_HEIGHT 8
#define GAME_GEAR_WALL_TEXTURE_PACKED_ROW_STRIDE 4
#define GAME_GEAR_WALL_TEXTURE_PACKED_ROW_SHIFT 2
