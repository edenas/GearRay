...
#define DOOR_WALL_X_NEAR_TILE_INDEX_BASE 198
#define DOOR_WALL_Y_NEAR_TILE_INDEX_BASE 206
#define DOOR_WALL_X_FAR_TILE_INDEX_BASE 214
#define DOOR_WALL_Y_FAR_TILE_INDEX_BASE 222
